...
# yolov9_config=dict(conf=0.3, iou=0.45, classes=[0, 2, 3]) DETECT ONLY SPECIFIC
yolov9_config=dict(conf=0.3, iou=0.45) # DETECT ALL
    ...
    def generate():
        ...
        for frame, detected_objects in process_video(
            ...
            for tracker_id, object_info in detected_objects.items():
                ...
                # print("DETECTED TRACKER ID: ",tracker_id, class_name)
