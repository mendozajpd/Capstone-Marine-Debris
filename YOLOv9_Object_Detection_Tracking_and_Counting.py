...
def process_video(model, config=dict(conf=0.1, iou=0.45, classes=True,), counting_zone=True, show_labels=True, source_path=SOURCE_VIDEO_PATH, target_path=TARGET_VIDEO_PATH, skip_frames=1):
    ...
    def callback(frame: np.ndarray, index: int) -> np.ndarray:
        ...
        # # Print the tracker IDs and their classes
        # print("Tracker IDs and Classes:", tracker_dict)
